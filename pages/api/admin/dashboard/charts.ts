...
export default async function handler(
  ...
  if (req.method === "GET") {
    try {
      ...
      const golsPorEquipeMap = new Map<
        number,
      ...
      // Corrigir nome das props para coincidir com frontend
      const chartsData = {
      ...
      return res.status(200).json(chartsData);
    } catch (error) {
